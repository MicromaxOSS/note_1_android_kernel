...
#define CWFG_I2C_BUSNUM 6 //CHANGE   Customer need to change this number according to the principle of hardware
...
//prize modified by huarui, support config by dts, 20190612 start
#elif defined(CONFIG_MTK_CW2015_SUPPORT_OF)
