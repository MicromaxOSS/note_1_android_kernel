...
#include "ov2680macro_mipi_Sensor.h"

/*********************Modify Following Strings for Debug********************/
#define PFX "OV2680macro_camera_sensor"
#define LOG_1 cam_pr_debug("OV2680macro,MIPI 1LANE\n")
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV2680MACROMIPI_SENSOR_ID,
