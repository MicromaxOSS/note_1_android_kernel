 ...
 * Filename:
 * ---------
 *   OV16A10_REAR_rear_mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#define PFX "OV16A10_camera_sensor"
#define LOG_1 LOG_INF("OV16A10,MIPI 4LANE,PDAF\n")
...
static kal_uint16
	ov16a10_table_write_cmos_sensor(kal_uint16 * para, kal_uint32 len);
#endif
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		.pclk = 100000000,	
		.linelength = 850,		/*OV16A10 Note: linelength/4,it means line length per lane*/
		.framelength = 3920,
		.startx = 0,
		.starty = 0,
	...
	.cap1 = {
		.pclk = 100000000,	
		.linelength = 850,		/*OV16A10 Note: linelength/4,it means line length per lane*/
		.framelength = 5880,			//record different mode's framelength
		.startx = 0,					//record different mode's startx of grabwindow
		.starty = 0,					//record different mode's starty of grabwindow
		.grabwindow_width = 4608,
		.grabwindow_height = 3456,
  ...
  .cap2 = {
		.pclk = 100000000,											//record different mode's pclk
		.linelength = 850,		/*OV16A10 Note: linelength/4,it means line length per lane*/
		.framelength = 7840,			//record different mode's framelength
		.startx = 0,					//record different mode's startx of grabwindow
		.starty = 0,					//record different mode's starty of grabwindow
		.grabwindow_width = 4608,
		.grabwindow_height = 3456,
	...
	.hs_video = {
		.pclk = 100000000,	
		.linelength = 750,		//90 fps:1386 /*OV16A10 Note: linelength/4,it means line length per lane*/
		.framelength = 1110,			//record different mode's framelength
		.startx = 0,					//record different mode's startx of grabwindow
		.starty = 0,					//record different mode's starty of grabwindow
...
static  struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] ={
	...
	{ 4688, 3528,     416,  676,3856, 2176, 1928, 1088,  4, 4,  1920, 1080,     0,    0, 1920, 1080}, //hight speed video
...
// prize add for start-up slow by zhuzhengjiang 20200603 start
#if USE_BURST_MODE
static kal_uint16 ov16a10_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
#if USE_BURST_MODE
static kal_uint16 ov16a10_init_setting[] = {
	...
	0x383e, 0x0d,
	0x383f, 0x33,
	0x3857, 0x01,//for mirror[on]& flip[on]
	0x388f, 0x00,
	0x3890, 0x00,
	0x3891, 0x00,
	0x3d81, 0x10,
...
//	0x4827, 0x52,
	...
	0x58cb, 0x03,
	0x5bd0, 0x41,
	0x5bd1, 0x06,	//for mirror[on]& flip[on]
	0x5c0e, 0x11,
	0x5c11, 0x01,
	0x5c16, 0x02,
	0x5c17, 0x00,
...
static kal_uint16 ov16a10_preview_setting[] = {	/*	preview_setting  */
	...
	0x3814, 0x11,
	0x3815, 0x11,
	0x3820, 0x04, //for mirror[on]& flip[on]
	0x3821, 0x02, //for mirror[on]& flip[on]
	0x3822, 0x11,
	0x383c, 0x22,
	0x4015, 0x04,
	0x4016, 0x1b,
...
static kal_uint16 ov16a10_normal_capture_setting[] = {
...
static kal_uint16 ov16a10_pip_capture_setting[] = {
...
static kal_uint16 ov16a10_pip_capture_15fps_setting[] = {
...
static kal_uint16 ov16a10_hs_video_setting[] = {
...
static void sensor_init(void)
{
	...
	ov16a10_table_write_cmos_sensor(ov16a10_init_setting,
		sizeof(ov16a10_init_setting)/sizeof(kal_uint16));
#else	
	...
	write_cmos_sensor_8(0x361e, 0x10);
	...
	write_cmos_sensor_8(0x3663, 0x02);
	write_cmos_sensor_8(0x3664, 0x07);
	...
	write_cmos_sensor_8(0x3823, 0x00);
	...
	write_cmos_sensor_8(0x3857, 0x01);//for mirror[on]& flip[on]
	...
	write_cmos_sensor_8(0x401b, 0x10);
	...
	write_cmos_sensor_8(0x4640, 0x00);
	write_cmos_sensor_8(0x4641, 0x24);
	write_cmos_sensor_8(0x4643, 0x08);
...
//	write_cmos_sensor_8(0x4819, 0x90);
	write_cmos_sensor_8(0x481b, 0x3c); //0x50);
//	write_cmos_sensor_8(0x4826, 0x50);
//	write_cmos_sensor_8(0x4827, 0x52);
	...
	write_cmos_sensor_8(0x5000, 0x0b);
	write_cmos_sensor_8(0x5001, 0x4b);
	write_cmos_sensor_8(0x5002, 0x57);
	write_cmos_sensor_8(0x5003, 0x42);
	write_cmos_sensor_8(0x5005, 0x40);
	write_cmos_sensor_8(0x5038, 0x40);
	...
	write_cmos_sensor_8(0x5bd0, 0x41);
	write_cmos_sensor_8(0x5bd1, 0x06);	//for mirror[on]& flip[on]
	write_cmos_sensor_8(0x5c0e, 0x11);
	write_cmos_sensor_8(0x5c11, 0x01);
	...
	write_cmos_sensor_8(0x5c24, 0x0a);
	write_cmos_sensor_8(0x5c25, 0x06);
	write_cmos_sensor_8(0x5c26, 0x0e);
	write_cmos_sensor_8(0x5c27, 0x02);
	write_cmos_sensor_8(0x5c28, 0x02);
	write_cmos_sensor_8(0x5c29, 0x0a);
	write_cmos_sensor_8(0x5c2a, 0x0a);
	...
	write_cmos_sensor_8(0x5d0b, 0x0a);
	write_cmos_sensor_8(0x5d0c, 0x06);
	write_cmos_sensor_8(0x5d0d, 0x0e);
	write_cmos_sensor_8(0x5d0e, 0x02);
	write_cmos_sensor_8(0x5d0f, 0x02);
	write_cmos_sensor_8(0x5d10, 0x0a);
	write_cmos_sensor_8(0x5d11, 0x0a);
	...
	write_cmos_sensor_8(0x5900, 0x40);
	write_cmos_sensor_8(0x5901, 0x40);
	write_cmos_sensor_8(0x5902, 0x40);
	write_cmos_sensor_8(0x5903, 0x40);
	write_cmos_sensor_8(0x5904, 0x40);
	write_cmos_sensor_8(0x5905, 0x40);
	write_cmos_sensor_8(0x5906, 0x40);
	write_cmos_sensor_8(0x5907, 0x40);
	write_cmos_sensor_8(0x5908, 0x40);
	write_cmos_sensor_8(0x5909, 0x40);
	write_cmos_sensor_8(0x590a, 0x40);
	write_cmos_sensor_8(0x590b, 0x40);
	write_cmos_sensor_8(0x590c, 0x40);
	write_cmos_sensor_8(0x590d, 0x40);
	write_cmos_sensor_8(0x590e, 0x40);
	write_cmos_sensor_8(0x590f, 0x40);
	write_cmos_sensor_8(0x5910, 0x40);
	write_cmos_sensor_8(0x5911, 0x40);
	write_cmos_sensor_8(0x5912, 0x40);
	write_cmos_sensor_8(0x5913, 0x40);
	write_cmos_sensor_8(0x5914, 0x40);
	write_cmos_sensor_8(0x5915, 0x40);
	write_cmos_sensor_8(0x5916, 0x40);
	write_cmos_sensor_8(0x5917, 0x40);
	write_cmos_sensor_8(0x5918, 0x40);
	write_cmos_sensor_8(0x5919, 0x40);
	write_cmos_sensor_8(0x591a, 0x40);
	write_cmos_sensor_8(0x591b, 0x40);
	write_cmos_sensor_8(0x591c, 0x40);
	write_cmos_sensor_8(0x591d, 0x40);
	write_cmos_sensor_8(0x591e, 0x40);
	write_cmos_sensor_8(0x591f, 0x40);
	write_cmos_sensor_8(0x5920, 0x40);
	write_cmos_sensor_8(0x5921, 0x40);
	write_cmos_sensor_8(0x5922, 0x40);
	write_cmos_sensor_8(0x5923, 0x40);
	write_cmos_sensor_8(0x5924, 0x40);
	write_cmos_sensor_8(0x5925, 0x40);
	write_cmos_sensor_8(0x5926, 0x40);
	write_cmos_sensor_8(0x5927, 0x40);
	write_cmos_sensor_8(0x5928, 0x40);
	write_cmos_sensor_8(0x5929, 0x40);
	write_cmos_sensor_8(0x592a, 0x40);
	write_cmos_sensor_8(0x592b, 0x40);
	write_cmos_sensor_8(0x592c, 0x40);
...
// prize add for start-up slow by zhuzhengjiang 20200603 start	
	...
	//mdelay(20);
#if USE_BURST_MODE  
	ov16a10_table_write_cmos_sensor(ov16a10_preview_setting,
		sizeof(ov16a10_preview_setting)/sizeof(kal_uint16));
#else	
	...
	write_cmos_sensor_8(0x3654, 0x8a);
	write_cmos_sensor_8(0x3656, 0x0c);
	write_cmos_sensor_8(0x37d0, 0x01);
	write_cmos_sensor_8(0x37d1, 0x10);
	write_cmos_sensor_8(0x37db, 0x08);
	write_cmos_sensor_8(0x3808, 0x09); // h size
	...
	write_cmos_sensor_8(0x3814, 0x11);
	write_cmos_sensor_8(0x3815, 0x11);
	write_cmos_sensor_8(0x3820, 0x04); //for mirror[on]& flip[on]
	write_cmos_sensor_8(0x3821, 0x02); //for mirror[on]& flip[on]
	write_cmos_sensor_8(0x3822, 0x11);
	write_cmos_sensor_8(0x383c, 0x22);
	write_cmos_sensor_8(0x4015, 0x04);
	write_cmos_sensor_8(0x4016, 0x1b);
	...
	write_cmos_sensor_8(0x4e26, 0x39);
	write_cmos_sensor_8(0x4e29, 0x6d);
	write_cmos_sensor_8(0x5000, 0x2b);
	write_cmos_sensor_8(0x5001, 0x4b);
	write_cmos_sensor_8(0x5002, 0x17);
	write_cmos_sensor_8(0x5820, 0xc3);
	//write_cmos_sensor_8(0x5bd0, 0x41);
	write_cmos_sensor_8(0x5c0e, 0x11);
	write_cmos_sensor_8(0x5c21, 0x10);
	write_cmos_sensor_8(0x5c22, 0x10);
...
// prize add for start-up slow by zhuzhengjiang 20200603 start
	...
	//mdelay(20);
#if USE_BURST_MODE
	// prize add by zhuzhengjiang for cts: testStillPreviewCombination start
	ov16a10_table_write_cmos_sensor(ov16a10_init_setting,
		sizeof(ov16a10_init_setting)/sizeof(kal_uint16));
	// prize add by zhuzhengjiang for cts: testStillPreviewCombination end
	ov16a10_table_write_cmos_sensor(ov16a10_normal_capture_setting,
		sizeof(ov16a10_normal_capture_setting)/sizeof(kal_uint16));
#else	
	write_cmos_sensor_8(0x0305, 0x89);
	write_cmos_sensor_8(0x0307, 0x00);
	...
	write_cmos_sensor_8(0x3815, 0x11);
#if 1//def MIRROR_FLIP_ENABLE
	write_cmos_sensor_8(0x3820, 0x04);
	...
	write_cmos_sensor_8(0x401f, 0x38);
	write_cmos_sensor_8(0x4500, 0x20);
	write_cmos_sensor_8(0x4501, 0x6f);
	write_cmos_sensor_8(0x4586, 0x00);
	write_cmos_sensor_8(0x4588, 0x02);
	write_cmos_sensor_8(0x4e05, 0x04);
	write_cmos_sensor_8(0x4e11, 0x06);
...
static void pip_capture_setting(void)
{
    ...
    LOG_INF( "OV16A10 PIP setting Enter!");

 	/*
	 * @@ OV16A10 4lane 4608x3456 20fps
...
// prize add for start-up slow by zhuzhengjiang 20200603 start
	...
	//mdelay(20);
#if USE_BURST_MODE 
	ov16a10_table_write_cmos_sensor(ov16a10_pip_capture_setting,
		sizeof(ov16a10_pip_capture_setting)/sizeof(kal_uint16));
#else
	write_cmos_sensor_8(0x0305, 0x89);
	write_cmos_sensor_8(0x0307, 0x00);
	write_cmos_sensor_8(0x4837, 0x0a);
	...
	write_cmos_sensor_8(0x380c, 0x03);
	write_cmos_sensor_8(0x380d, 0x52);
	write_cmos_sensor_8(0x380e, 0x16);
...
// prize add for start-up slow by zhuzhengjiang 20200603 start
	...
	//mdelay(20);
#if USE_BURST_MODE 
	ov16a10_table_write_cmos_sensor(ov16a10_pip_capture_15fps_setting,
		sizeof(ov16a10_pip_capture_15fps_setting)/sizeof(kal_uint16));
#else
	write_cmos_sensor_8(0x0305, 0x89);
	write_cmos_sensor_8(0x0307, 0x00);
	write_cmos_sensor_8(0x4837, 0x0a);
	...
	write_cmos_sensor_8(0x380f, 0xA0);
	write_cmos_sensor_8(0x3814, 0x11);
	write_cmos_sensor_8(0x3815, 0x11);
#if 1//def MIRROR_FLIP_ENABLE
	write_cmos_sensor_8(0x3820, 0x04);
...
static void hs_video_setting(void)
{
	...
	/*
	* @@ OV16A10 4lane 1920*1080 120fps hvbin
...
// prize add for start-up slow by zhuzhengjiang 20200603 start	
	...
	//mdelay(20);
#if USE_BURST_MODE 
	ov16a10_table_write_cmos_sensor(ov16a10_hs_video_setting,
		sizeof(ov16a10_hs_video_setting)/sizeof(kal_uint16));
#else
	write_cmos_sensor_8(0x0305, 0x68);
	...
	write_cmos_sensor_8(0x0345, 0xf0);
	write_cmos_sensor_8(0x034a, 0x05);
	write_cmos_sensor_8(0x360a, 0x68);
	write_cmos_sensor_8(0x361a, 0xc9);
	write_cmos_sensor_8(0x3639, 0xa8);
	write_cmos_sensor_8(0x3654, 0x0a);
	write_cmos_sensor_8(0x3656, 0x0a);
	write_cmos_sensor_8(0x37d0, 0x02);
	write_cmos_sensor_8(0x37d1, 0x0c);
	write_cmos_sensor_8(0x37db, 0x02);
	...
	write_cmos_sensor_8(0x380d, 0xee);
	write_cmos_sensor_8(0x380e, 0x04);
	write_cmos_sensor_8(0x380f, 0x56);
	write_cmos_sensor_8(0x3814, 0x11);
	write_cmos_sensor_8(0x3815, 0x31);
#if 1//def MIRROR_FLIP_ENABLE
	write_cmos_sensor_8(0x3820, 0x05);
	write_cmos_sensor_8(0x3821, 0x02);
#else
	write_cmos_sensor_8(0x3820, 0x01);
	write_cmos_sensor_8(0x3821, 0x06);
#endif
	write_cmos_sensor_8(0x3822, 0x01);
	write_cmos_sensor_8(0x383c, 0x12);
	write_cmos_sensor_8(0x4015, 0x02);
	write_cmos_sensor_8(0x4016, 0x09);
	write_cmos_sensor_8(0x4017, 0x00);
	write_cmos_sensor_8(0x4018, 0x03);
	write_cmos_sensor_8(0x401e, 0x01);
	write_cmos_sensor_8(0x401f, 0x38);
	write_cmos_sensor_8(0x4500, 0x28);
	write_cmos_sensor_8(0x4501, 0x00);
	write_cmos_sensor_8(0x4586, 0x00);
	write_cmos_sensor_8(0x4588, 0x02);
	write_cmos_sensor_8(0x4e05, 0x01);
	write_cmos_sensor_8(0x4e11, 0x03);
	write_cmos_sensor_8(0x4e1d, 0x1b);
	write_cmos_sensor_8(0x4e26, 0x3e);
	write_cmos_sensor_8(0x4e29, 0x3a);
	write_cmos_sensor_8(0x5000, 0x2b);
	write_cmos_sensor_8(0x5001, 0xcb);
	write_cmos_sensor_8(0x5002, 0x17);
	write_cmos_sensor_8(0x5820, 0xc1);
	write_cmos_sensor_8(0x5bd0, 0x09);
	write_cmos_sensor_8(0x5c0e, 0x11);
	write_cmos_sensor_8(0x5c21, 0x10);
	...
	write_cmos_sensor_8(0x5c25, 0x06);
	write_cmos_sensor_8(0x5c26, 0x0e);
	write_cmos_sensor_8(0x5c27, 0x00);
	write_cmos_sensor_8(0x5c28, 0x00);
	write_cmos_sensor_8(0x5c29, 0x04);
	write_cmos_sensor_8(0x5c2a, 0x04);
	write_cmos_sensor_8(0x5d08, 0x10);
	...
	write_cmos_sensor_8(0x5d0c, 0x06);
	write_cmos_sensor_8(0x5d0d, 0x0e);
	write_cmos_sensor_8(0x5d0e, 0x00);
	write_cmos_sensor_8(0x5d0f, 0x00);
	write_cmos_sensor_8(0x5d10, 0x04);
	write_cmos_sensor_8(0x5d11, 0x04);

	write_cmos_sensor_8(0x3501, 0x04);
	write_cmos_sensor_8(0x3502, 0x4e);
	write_cmos_sensor_8(0x3508, 0x01);
	write_cmos_sensor_8(0x3509, 0x00);
	//No, 0xPD, 0xoutput
	#if  1
