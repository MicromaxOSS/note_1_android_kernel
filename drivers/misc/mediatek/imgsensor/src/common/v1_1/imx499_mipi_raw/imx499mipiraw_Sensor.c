...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.i2c_addr_table = {0x34, 0xff},	/* record sensor support all write id addr,
...
static struct SET_PD_BLOCK_INFO_T pd_block_info_cap = {
	.i4OffsetX = 86,
	.i4OffsetY = 96,
	.i4PitchX = 32,
	.i4PitchY = 32,
...
static struct SET_PD_BLOCK_INFO_T pd_block_info_normal_video = {
	.i4OffsetX = 86,
	.i4OffsetY = 96,
	.i4PitchX = 32,
	.i4PitchY = 32,
...
static void hs_video_setting(void)
{
	...
	/*************output size setting******/
	write_cmos_sensor(0x034C, 0x05);//07
	write_cmos_sensor(0x034D, 0x00);//80
	write_cmos_sensor(0x034E, 0x02);//04
	write_cmos_sensor(0x034F, 0xD0);//38
	/************clock setting****************/
	write_cmos_sensor(0x0301, 0x06);
	write_cmos_sensor(0x0303, 0x02);
	write_cmos_sensor(0x0305, 0x02);
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		imx499_awb_gain((struct SET_SENSOR_AWB_GAIN *) feature_para);
		break;
		/*END OF HDR CMD */
		/*PDAF CMD */
