...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.checksum_value = 0xbd50d79d, //0x362cca75,
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_Gr, //SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_Gb,SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_B,SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_R,SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_Gr
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =
{
   ...
   .i4SubBlkW = 8,
   .i4SubBlkH = 2, 
   .i4PosL = {{0, 0}, {8, 0}, {2, 3}, {10, 3}, {6, 4}, {14, 4}, {4, 7}, {12, 7},{0, 8}, {8, 8}, {2, 11}, {10, 11}, {6, 12}, {14, 12}, {4, 15}, {12, 15} },   
   .i4PosR = {{1, 0}, {9, 0}, {3, 3}, {11, 3}, {7, 4}, {15, 4}, {5, 7}, {13, 7},{1, 8}, {9, 8}, {3, 11}, {11, 11}, {7, 12}, {15, 12}, {5, 15}, {13, 15} },
   .iMirrorFlip = 0,
   .i4BlockNumX = 290,
   .i4BlockNumY = 217,
};
...
static kal_uint32 return_sensor_id(void)
{
	...
	LOG_INF("[%s] sensor_id: 0x%x module_id: 0x%x revision: EVT0.%d\n", __func__, sensor_id, module_id, revision);
...
*/
		...
		imgsensor.current_ae_effective_frame = 0;
	} else {
		imgsensor.current_ae_effective_frame = 0;
		if (bIsLongExposure) {
			LOG_INF("brad enter normal shutter.\n");
			write_cmos_sensor(0x6028, 0x4000);
			write_cmos_sensor_8(0x0100, 0x00); /*stream off*/
			...
			LOG_INF("===brad enter normal shutter shutter = %d, imgsensor.frame_lengths = 0x%x, imgsensor.line_length = 0x%x\n",
		...
		/* Update Shutter */
		write_cmos_sensor(0x0202, shutter);
		LOG_INF("shutter =%d, framelength =%d gw1_binning_mode= %d\n",
...
static kal_uint32 streaming_control(kal_bool enable)
{
	...
	if (enable) {
		...
		if (bIsLongExposure) {
			LOG_INF("brad interrupt in long shutter. \n");
			write_cmos_sensor(0x6028, 0x4000);
			write_cmos_sensor_8(0x0100, 0x00); /*stream off*/
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		LOG_INF("braddbg now slave is 0x%x", imgsensor.i2c_write_id);
		spin_unlock(&imgsensor_drv_lock);
		do {
			mDELAY(10);
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				LOG_INF("gw1 i2c write id: 0x%x, sensor id: 0x%x, info.sensor_id: 0x%x\n",
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			if (sensor_id == imgsensor_info.sensor_id) {
				LOG_INF("gw1 open i2c write id: 0x%x, sensor id: 0x%x, info.sensor_id: 0x%x\n",
					imgsensor.i2c_write_id, sensor_id, imgsensor_info.sensor_id);
				break;
			}
