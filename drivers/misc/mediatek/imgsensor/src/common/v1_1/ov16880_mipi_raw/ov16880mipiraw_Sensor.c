...
extern bool read_eeprom( u16 addr, BYTE* data, u32 size);

#undef PDAF_TEST
//#define PDAF_TEST 1
#ifdef PDAF_TEST
extern bool wrtie_eeprom(u16 addr, BYTE data[],u32 size );
char data[4096]= {
...
static imgsensor_info_struct imgsensor_info = {
  ...
  .cap2 = {
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B, //SENSOR_OUTPUT_FORMAT_RAW_B,
	.mclk = 24,
...
static void preview_setting(void)
{
	...
	*/
	...
	write_cmos_sensor_8(0x3813, 0x04);//02->04
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if (enable) {
		...
		write_cmos_sensor_8(0x5000, 0x9a);
		write_cmos_sensor_8(0x5001, 0x0e);
	} else {
		// 0x5E00[8]: 1 enable,  0 disable
		// 0x5E00[1:0]; 00 Color bar, 01 Random Data, 10 Square, 11 BLACK
		write_cmos_sensor_8(0x5280, 0x00);
		write_cmos_sensor_8(0x5000, 0x9f);
		write_cmos_sensor_8(0x5001, 0x4e);
	}
	spin_lock(&imgsensor_drv_lock);
