...
#include "s5kgm1spgmsmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGM1SPGMS_SENSOR_ID,
...
//prize add by lipengpeng 20200215 start
 #define GMS_MODULE_ID_OFFSET  0x0003
static kal_uint16 read_gmsmodule_id(void)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = {(char)(GMS_MODULE_ID_OFFSET >> 8), (char)(GMS_MODULE_ID_OFFSET & 0xFF)};
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	kal_uint16 module_id = 0,gmsmodule_id = 0;
	...
	/*prize add by zhuzhengjiang for search camera 2019622 end*/
	//prize add by lipengpeng 20200215 start
		gmsmodule_id = read_gmsmodule_id();
	printk("111LPP,gmsmodule_id=%x",gmsmodule_id);
	if(gmsmodule_id !=0x0B){
		...
		do {
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001))+1;
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				//add by wq 	register_imgsensor_deviceinfo("Cam_b", DEVICE_VERSION_S5KGM1SP, module_id);
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		s5kgm1sp_get_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		 ...
		 *	(*feature_para_len));
		 */
		s5kgm1sp_set_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
#endif
