...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B, // remosaic : SENSOR_OUTPUT_FORMAT_RAW_4CELL_HW_BAYER_B
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	printk("imx582 get_imgsensor_id entry\n");
