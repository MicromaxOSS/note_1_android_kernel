 ...
 * Filename:
 * ---------
 *   OV32A1Q0242_REAR_rear_mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "ov32a1q0242mipiraw_Sensor.h"
//#include "ov32a1q0242_eeprom.h"

#define PFX "OV32A1Q0242_camera_sensor"
#define LOG_1 LOG_INF("OV32A1Q0242,MIPI 4LANE,PDAF\n")
...
// prize add by zhuzhengjiang for cts:testSupportedVideoSizes 20200512 start
#if USE_BURST_MODE
static kal_uint16 ov32a1q0242_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
static kal_uint16 ov32a1q0242_init_setting[] = {
	0x0103, 0x01,
	0x0302, 0x31,
	0x0323, 0x05,
	0x0324, 0x01,
...
static kal_uint16 ov32a1q0242_preview_setting[] = {
	0x0305, 0x29,
	0x0344, 0x01,
	0x0345, 0xe0,
	0x034a, 0x06,
...
static kal_uint16 ov32a1q0242_capture_setting[] = {
	0x0305, 0x29,
	0x0344, 0x01,
	0x0345, 0xe0,
	0x034a, 0x06,
...
static void sensor_init(void)
{
	...
	ov32a1q0242_table_write_cmos_sensor(ov32a1q0242_init_setting,
		sizeof(ov32a1q0242_init_setting)/sizeof(kal_uint16));
#else
...
static void preview_setting(void)
{
	...
	mdelay(20);
#if USE_BURST_MODE
	ov32a1q0242_table_write_cmos_sensor(ov32a1q0242_preview_setting,
		sizeof(ov32a1q0242_preview_setting)/sizeof(kal_uint16));
#else
	// prize add by zhuzhengjiang for cts:testSupportedVideoSizes 20200512 end
...
static void capture_setting(kal_uint16 currefps)
{
	...
	mdelay(20);
#if USE_BURST_MODE
	ov32a1q0242_table_write_cmos_sensor(ov32a1q0242_capture_setting,
		sizeof(ov32a1q0242_capture_setting)/sizeof(kal_uint16));
#else
	// prize add by zhuzhengjiang for cts:testSupportedVideoSizes 20200512 end
	write_cmos_sensor(0x0305, 0x29);
	write_cmos_sensor(0x0344, 0x01);
...
/*prize add by zhuzhengjiang for Compatible of OHF0242 and OHF9359 20201215 start*/
static kal_uint16 get_module_id(kal_uint32 addr)
{
		kal_uint16 get_byte = 0;
		char pusendcmd[2] = { (char)(addr >> 8), (char)(addr & 0xFF) };
...
/*prize add by zhuzhengjiang for Compatible of OHF0242 and OHF9359 20201215 end*/
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	kal_uint16 module_id = 0;/*prize add by zhuzhengjiang for Compatible of OHF0242 and OHF9359 start*/
	if(curr_sensor_id != 1){
		*sensor_id = 0xFFFFFFFF;
		return ERROR_SENSOR_CONNECT_FAIL;
	}
	//kal_uint8 ov32a1q0242_module_id = 0;
	//sensor have two i2c address 0x6c 0x6d & 0x21 0x20, we should detect the module used i2c address
	printk("ov32a1q0242 get_imgsensor_id entry\n");
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {	
				*sensor_id = return_sensor_id();
				/*prize add by zhuzhengjiang for Compatible of OHF0242 and OHF9359 20201215 start*/
				module_id = get_module_id(0x0F78);
...
static kal_uint32 open(void)
{
	...
	kal_uint16 module_id = 0;/*prize add by zhuzhengjiang for Compatible of OHF0242 and OHF9359 20201215 start */
	/* sensor have two i2c address 0x6c 0x6d & 0x21 0x20, we should detect the module used i2c address */
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		spin_lock(&imgsensor_drv_lock);
		imgsensor.i2c_write_id = imgsensor_info.i2c_addr_table[i];
							 ...
							 UINT8 *feature_para,UINT32 *feature_para_len)
{
	...
	switch (feature_id) 
	{
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:
			...
			//read_ov32a1q0242_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;
	...
	//prize-camera  add for  by zhuzhengjiang 20190830-end
		...
		case SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY:
			...
			//PDAF capacity enable or not, OV32A1Q0242 only full size support PDAF
			switch (*feature_data) 
			{
				case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
...
UINT32 OV32A1Q0242_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	OV32A1Q0242_MIPI_RAW_SensorInit	*/
