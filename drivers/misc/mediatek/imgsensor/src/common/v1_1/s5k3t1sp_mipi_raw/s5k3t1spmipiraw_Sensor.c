...
#include "s5k3t1spmipiraw_Sensor.h"
//Hisense pangfei add for module device info start	
#ifdef CONFIG_HISENSE_PRODUCT_DEVINFO
#include <linux/productinfo.h>
static char *sensor_name = "S5K3T1SP_HXSEF03";
#endif
//Hisense pangfei add for module device info end	

#define PFX "S5K3T1SP_camera_sensor"
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	{ 5184, 3880, 272, 200, 4640, 3480, 2320,  1740, 0, 0, 2320, 1740, 0, 0, 2320,  1740 },//perview
	{ 5184, 3880, 272, 200, 4640, 3480, 2320,  1740, 0, 0, 2320, 1740, 0, 0, 2320,  1740 },//capture
	{ 5184, 3880, 272, 200, 4640, 3480, 2320,  1740, 0, 0, 2320, 1740, 0, 0, 2320,  1740 },//normal_video
	{ 5184, 3880, 272, 200, 4640, 3480, 2320,  1740, 0, 0, 2320, 1740, 0, 0, 2320,  1740 },//hs_video
	{ 5184, 3880, 272, 200, 4640, 3480, 2320,  1740, 0, 0, 2320, 1740, 0, 0, 2320,  1740 },//slime_video
};
...
kal_uint16 addr_data_pair_init1_s5k3t1sp[] = {
  0x6028, 0x2000,
  0x602A, 0x5128,
  0x6F12, 0x0000,
  0x6F12, 0x0000,
...
static void sensor_init(void)
{
  ...
  write_cmos_sensor(0x0A02, 0x007C);
	...
	table_write_cmos_sensor(addr_data_pair_init1_s5k3t1sp,
				sizeof(addr_data_pair_init1_s5k3t1sp) / sizeof(kal_uint16));

//	table_write_cmos_sensor(addr_data_pair_init2_s5k3t1sp,
//			sizeof(addr_data_pair_init2_s5k3t1sp) / sizeof(kal_uint16));

}	/*	sensor_init  */

kal_uint16 addr_data_pair_preview_s5k3t1sp[] = {
  0x6028, 0x4000,
  0x0136, 0x1800,
  0x0304, 0x0003,
  0x0306, 0x00AF,
...
static void preview_setting(void)
{
	...
	table_write_cmos_sensor(addr_data_pair_preview_s5k3t1sp,
			sizeof(addr_data_pair_preview_s5k3t1sp) / sizeof(kal_uint16));
}	/*	preview_setting  */

kal_uint16 addr_data_pair_cap30fps_s5k3t1sp[] = {
  0x6028, 0x4000,
  0x0136, 0x1800,
  0x0304, 0x0003,
  0x0306, 0x00AF,
...
#if 1
kal_uint16 addr_data_pair_cap24fps_s5k3t1sp[] = {
  0x6028, 0x4000,
  0x0136, 0x1800,
  0x0304, 0x0003,
  0x0306, 0x00AF,
...
#endif
kal_uint16 addr_data_pair_cap15fps_s5k3t1sp[] = {
  0x6028, 0x4000,
  0x0136, 0x1800,
  0x0304, 0x0003,
  0x0306, 0x00AF,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
		table_write_cmos_sensor(addr_data_pair_cap30fps_s5k3t1sp,
					sizeof(addr_data_pair_cap30fps_s5k3t1sp) /
					sizeof(kal_uint16));
	} 
#if 1
	else if (currefps == 240) {
		table_write_cmos_sensor(addr_data_pair_cap24fps_s5k3t1sp,
					sizeof(addr_data_pair_cap24fps_s5k3t1sp) /
					sizeof(kal_uint16));
	}
#endif	
	else { /*15fps*/
		table_write_cmos_sensor(addr_data_pair_cap15fps_s5k3t1sp,
					sizeof(addr_data_pair_cap15fps_s5k3t1sp) /
					sizeof(kal_uint16));
	}
	//write_cmos_sensor(0x6214, 0x7970);
...
#if 0
kal_uint16 addr_data_pair_normal_video_s5k3t1sp[] = {
  0x6028, 0x4000,
  0x0136, 0x1800,
  0x0304, 0x0003,
  0x0306, 0x00AF,
...
#if 1
kal_uint16 addr_data_pair_hs_video_s5k3t1sp[] = {
  0x6028, 0x4000,
  0x0136, 0x1800,
  0x0304, 0x0003,
  0x0306, 0x00AF,
...
static void hs_video_setting(void)
{
	...
	/*720p 120fps*/
	table_write_cmos_sensor(addr_data_pair_hs_video_s5k3t1sp,
				sizeof(addr_data_pair_hs_video_s5k3t1sp) / sizeof(kal_uint16));

	//write_cmos_sensor_8(0x0B0E, 0x01);

}
#if 0
kal_uint16 addr_data_pair_slim_video_s5k3t1sp[] = {
  0x6028, 0x4000,
  0x0136, 0x1800,
  0x0304, 0x0003,
  0x0306, 0x00AF,
		...
		do {
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001));
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				//Hisense pangfei add for module device info start	
				#ifdef CONFIG_HISENSE_PRODUCT_DEVINFO
				productinfo_register(PRODUCTINFO_FRONT_CAMERA_ID,sensor_name,NULL);
				#endif	
				//Hisense pangfei add for module device info end
				return ERROR_NONE;
			}
...
UINT32 S5K3T1SP_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
