...
static void lcm_get_params(struct LCM_PARAMS *params)
	...
	params->dsi.vertical_backporch					= 2;//16 25 30 35 12 8
	params->dsi.vertical_frontporch					= 4;
	params->dsi.vertical_active_line				= FRAME_HEIGHT; 

	params->dsi.horizontal_sync_active = 10;
	params->dsi.horizontal_backporch = 46;//32
	params->dsi.horizontal_frontporch = 56;//78
	params->dsi.horizontal_active_pixel = FRAME_WIDTH;
	/* params->dsi.ssc_disable                                                       = 1; */

	params->dsi.PLL_CLOCK = 535;//244;
		params->dsi.ssc_disable = 1;
...
data_array[0] = 0x00053902;
data_array[1] = 0x0900002B;
data_array[2] = 0x00000023;
dsi_set_cmdq(data_array, 3, 1);

data_array[0] = 0x00053902;
data_array[1] = 0x02000030;
data_array[2] = 0x000000A7;
dsi_set_cmdq(data_array, 3, 1);
...
extern void syna_tcm_reset_syc_lcd(int en);

static void lcm_init(void)
{
	syna_tcm_reset_syc_lcd(0);
...
struct LCM_DRIVER td4330_fhdp_dsi_vdo_auo_drv = 
{
    .name			= "td4330_fhdp_dsi_vdo_auo_auo",
