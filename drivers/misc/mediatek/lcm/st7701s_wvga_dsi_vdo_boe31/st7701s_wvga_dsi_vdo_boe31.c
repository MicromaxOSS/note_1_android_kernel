...
static __maybe_unused struct LCM_setting_table lcm_initialization_setting[] = {
{0x01,  1 ,{0x00}},
...
static __maybe_unused struct LCM_setting_table lcm_sleep_mode_in_setting[] = {
...
static __maybe_unused void push_table(struct LCM_setting_table *table, unsigned int count, unsigned char force_update)
{
    unsigned int i;
...
static unsigned int lcm_compare_id(void)
{
    ...
    if ((id == 0xffffff)||(id = LCM_ID_ST7701S)){	//default = 0xffffff
		return 1;
	}else{
		return 0;
	}
...
struct LCM_DRIVER st7701s_wvga_dsi_vdo_boe31_lcm_drv = 
{
