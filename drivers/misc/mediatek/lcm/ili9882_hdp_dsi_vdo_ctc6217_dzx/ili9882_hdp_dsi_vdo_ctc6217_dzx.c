...
{0x03,01,{0x01}},  //vcom1[8] //prize 
{0x04,01,{0x23}},  //vcom1[7:0]//prize 
//{0x50,01,{0x2F}},  //x3 VGH
//{0x56,01,{0x73}},  //x3
//{0x58,01,{0x63}},  //X3 VGL
...
{0xD9,01,{0x1f}}, ////3lane:0x10 4lane:0x18
{0xc0,01,{0xF0}}, //Internal RTB
{0xc1,01,{0x15}}, //
...
{0xE0,27,{0x00,0x24,0x58,0x81,0xB9,0x54,0xEA,0x13,0x42,0x69,0xa5,0xA8,0xDB,0x0B,0x3A,0xEA,0x6D,0xab,0xd2,0x01,0xFf,0x27,0x57,0x8e,0xba,0x03,0xEC}},
{0xE1,27,{0x00,0x24,0x58,0x81,0xB9,0x54,0xEA,0x13,0x42,0x69,0xa5,0xA8,0xDB,0x0B,0x3A,0xEA,0x6D,0xab,0xd2,0x01,0xFf,0x27,0x57,0x8e,0xba,0x03,0xEC}},
...
{0x11,01,{0x10}},
{0x13,01,{0x10}},		//PWM 设定开关
{0x00,01,{0xA0}},		//PWM 设定开关
...
static unsigned int lcm_compare_id(void)
{
    ...
    int id=0;
//prize add by lipengpeng 20200728 start	
    ...
    SET_RESET_PIN(1);
    MDELAY(120);
//prize add by lipengpeng 20200728 end 
   ...
   // dsi_set_cmdq(array, 2, 1);
    ...
    dsi_set_cmdq(array, 1, 1);
    //MDELAY(10);
    read_reg_v2(0xf2, &buffer[1], 1);//    NC 0x00  0x98 0x16
...
#endif
struct LCM_DRIVER ili9882_hdp_dsi_vdo_ctc6217_dzx_lcm_drv = 
{
  .name			= "ili9882_hdp_dsi_vdo_ctc6217_dzx",
