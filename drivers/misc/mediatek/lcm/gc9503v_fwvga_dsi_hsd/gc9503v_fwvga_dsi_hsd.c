...
//	params->dbi.te_edge_polarity = LCM_POLARITY_RISING;
	...
	params->physical_width = 57;//LCM_PHYSICAL_WIDTH/1000;
	params->physical_height = 114;//LCM_PHYSICAL_HEIGHT/1000;
	params->physical_width_um = 56796;//LCM_PHYSICAL_WIDTH;	= sqrt((size*25.4)^2/(18^2+9^2))*9*1000
	params->physical_height_um = 113592;//LCM_PHYSICAL_HEIGHT; = sqrt((size*25.4)^2/(18^2+9^2))*18*1000
...
struct LCM_DRIVER gc9503v_fwvga_dsi_hsd_lcm_drv = {
