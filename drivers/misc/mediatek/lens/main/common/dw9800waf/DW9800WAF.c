...
//#define LOG_INF(format, args...) printk
...
//prize fengshangdong update for imx499 lens driver at 20190116
...
static int gt9800_init(void)
{
	int i4RetValue = 0;
	char puSendCmd[3];
   
	printk("[GT9800AF] gt9800_init - beg\n");
	puSendCmd[0] = 0x02;
	puSendCmd[1] = 0x02;
	...
	LOG_INF("[GT9800AF] GT9766A SRC Init End!! \n");
