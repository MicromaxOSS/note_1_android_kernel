...
static int bf_spi_probe (struct spi_device *spi)
{
	...
	/*if(IS_FINGER_USED){
		BF_LOG("bf_spi_probe  IS_FINGER_USED failed");
...
#endif
#if defined TEE_BEANPOD
	{
        /* betterlife define, flow by beapond 300 */
        struct TEEC_UUID vendor_uuid = {0xf74c8d0d, 0x4284, 0x4acf, \
            {0xd0, 0xc4, 0x25, 0x26, 0x06, 0x10, 0xb3, 0xbd} \
        };
