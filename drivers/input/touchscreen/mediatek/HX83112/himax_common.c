...
#endif
/*prize penggy add-for TP-20190322-start*/
#if defined(HX_AUTO_UPDATE_FW)
unsigned char i_CTPM_FW[]=
{
#include "K6306Q_HLT_kubee_D00C05_20190322.i"
};
#endif
/*prize penggy add-for TP-20190322-end*/
...
#if defined(HX_SMART_WAKEUP) || defined(HX_PALM_REPORT) || defined(HX_INSPECT_LPWUG_TEST)
